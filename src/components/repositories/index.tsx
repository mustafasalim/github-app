...
function Repo() {
  return (
    <div className="w-[500px] h-[150px] rounded-2xl repoBackground">
      <div className="grid pl-5 pt-5 gap-y-2">
        <div className="text-[#CDD5E0] text-[20px]">.github</div>
        <div className="text-[#96A3B4] text-[15px]">
          Comumunity healt files for the @Github organization
        </div>
      </div>
